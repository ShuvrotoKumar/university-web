...
const Header = () => {
    ...
    const isSpecialPage = ['/','/universities', '/courses', '/community', '/news', '/blog', '/about', '/terms', '/contact', '/faqs', '/cookie', '/privacy'].includes(pathname);
    const headerBgColor = isSpecialPage ? 'bg-black' : 'bg-#101829';

    return (
        <header className={`${headerBgColor} shadow-sm sticky top-0 z-50 transition-all duration-300 ${isMounted && isScrolled ? 'mx-auto w-4/5 rounded-lg mt-4' : 'w-full'}`}>
